...
CREATE TABLE trips (
  ...
  dropoff_quarter integer,
  dropoff_month integer,
  dropoff_week integer,
  dropoff_day integer,
  dropoff_dow integer,
  dropoff_doy integer,
  ...
  payment_type varchar,
  trip_type integer,
  pickup_t_gid integer,
  dropoff_t_gid integer,
  t_tuple varchar,
  pickup_bg_gid integer,
  dropoff_bg_gid integer,
  bg_tuple varchar,
  pickup_b_gid integer,
  dropoff_b_gid integer,
  b_tuple varchar,
  pickup_tz_gid integer,
  dropoff_tz_gid integer,
  tz_tuple varchar
);
