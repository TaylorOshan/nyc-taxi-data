...
sed -E '/(.*,){18,}/d' data/yellow_tripdata_2010-02.csv > data/yellow_tripdata_2010-02.csv.tmp && mv data/yellow_tripdata_2010-02.csv.tmp data/yellow_tripdata_2010-02.csv
#sed -E '/(.*,){18,}/d' data/yellow_tripdata_2010-03.csv > data/yellow_tripdata_2010-03.csv
sed -E '/(.*,){18,}/d' data/yellow_tripdata_2010-03.csv > data/yellow_tripdata_2010-03.csv.tmp && mv data/yellow_tripdata_2010-03.csv.tmp data/yellow_tripdata_2010-03.csv
